...
var patternAddress = /^[a-zA-Z0-9\s.,;:?!()\-_'\"&@#/$%*]*$/;
...
function validateForm() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                if (this.responseText.length > 2) {
                    ...
                    document.getElementById("email").parentNode.append(generateErrorElement(
                        '<div class="custom_error_message_container" id="error_message_1"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Patient account already exists!</span></div>'
                    ));
    ...
    if (inputData != "" && inputData != null) {
        if (patternAddress.test(inputData) == false) {
            document.getElementById("address").parentNode.append(generateErrorElement(
            ...
            document.getElementById("address").classList.add = "error_input_field";
            console.log("Incorrect Format");
            valid = false;
        } else {
            document.getElementById("address").classList.add = "valid_input_field";
            console.log("Correct Format");
        }
    } else {
        document.getElementById("address").parentNode.append(generateErrorElement(
    ...
    if (inputData != "" && inputData != null) {
        if (patternContactNo.test(inputData) == false) {
            document.getElementById("contactNo").parentNode.append(generateErrorElement(
                '<div class="custom_error_message_container" id="error_message_11"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Enter a valid contact number</span></div>'
            ));
        ...
        document.getElementById("contactNo").parentNode.append(generateErrorElement(
            '<div class="custom_error_message_container" id="error_message_12"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">This field is required!</span></div>'
        ));
        document.getElementById("contactNo").classList.add = "error_input_field";
        console.log("Input Empty");
        valid = false;
    ...
    if (inputData != "" && inputData != null) {
        if (patternDate.test(inputData) == false) {
            document.getElementById("dob").parentNode.append(generateErrorElement(
                '<div class="custom_error_message_container" id="error_message_13"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Please enter a valid date of birth</span></div>'
            ));
        ...
        document.getElementById("dob").parentNode.append(generateErrorElement(
            '<div class="custom_error_message_container" id="error_message_14"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">This field is required!</span></div>'
        ));
        document.getElementById("dob").classList.add = "error_input_field";
        console.log("Input Empty");
        valid = false;
    ...
    inputData = document.getElementById("nationality").value;
    if (inputData == "-1") {
        document.getElementById("nationality").parentNode.append(generateErrorElement(
        ...
        document.getElementById("nationality").classList.add = "error_input_field";
        console.log("Incorrect Format");
        valid = false;
    } else {
        document.getElementById("nationality").classList.add = "valid_input_field";
        console.log("Correct Format");
    }

    inputData = document.getElementById("eContactNo").value;
    if (inputData != "" && inputData != null) {
        if (patternContactNo.test(inputData) == false) {
            document.getElementById("eContactNo").parentNode.append(generateErrorElement(
                '<div class="custom_error_message_container" id="error_message_16"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Enter a valid contact number</span></div>'
            ));
            document.getElementById("eContactNo").classList.add = "error_input_field";
            console.log("Incorrect Format");
            valid = false;
        } else {
            document.getElementById("eContactNo").classList.add = "valid_input_field";
            console.log("Correct Format");
        }
    } else {
        document.getElementById("eContactNo").parentNode.append(generateErrorElement(
            '<div class="custom_error_message_container" id="error_message_17"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">This field is required!</span></div>'
        ));
        document.getElementById("eContactNo").classList.add = "error_input_field";
        console.log("Input Empty");
        valid = false;
    ...
    if (myPassword != "" && myPassword != null) {
        if (myRePassword != "" && myRePassword != null) {
            if (myPassword != myRePassword) {
                ...
                alertDiv.innerHTML =
                    '<div class="custom_error_message_container" id="error_message_18"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Passwords do not match. Try again.</span></div>';
                ...
                if (patternPassword.test(myPassword) == false) {
                    ...
                    const alertDiv = document.createElement("div");
                    alertDiv.innerHTML =
                        '<div class="custom_error_message_container" id="error_message_19"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">Password is in incorrect format!</span></div>';
                    document.getElementById('passwordSwap').insertBefore(alertDiv, document.getElementsByClassName(
                        'custom_alert_info_register')[0]);
                }
            }
            ...
            const alertDiv = document.createElement("div");
            alertDiv.innerHTML =
                '<div class="custom_error_message_container" id="error_message_20"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">This field is required!</span></div>';
            document.getElementById('passwordSwap').insertBefore(alertDiv, document.getElementsByClassName(
                'custom_alert_info_register')[0]);
        ...
        document.getElementById("password").parentNode.append(generateErrorElement(
            '<div class="custom_error_message_container" id="error_message_21"><i class="fa fa-exclamation-circle"></i><span class="custom_error_message">This field is required!</span></div>'
        ));
        valid = false;
    }
    console.log(valid);
