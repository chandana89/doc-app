...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(ISSET($_POST["RegisterDoctor"])){
        ...
        $sql2 = "INSERT INTO Doctor (FirstName, LastName, ContactNumber, DateOfBirth, Gender, Description, SpecializationID, AccountID, HospitalID) VALUES (?,?,?,?,?,?,?,?,?)";

    
        if ($stmt2 = mysqli_prepare($conn, $sql2)) {
            mysqli_stmt_bind_param($stmt2, "sssssssss", $param_firstName, $param_lastName, $param_contact, $param_DateOfBirth, $param_gender, $param_description, $param_specialization, $param_accountId, $param_HospitalID);
            ...
            $param_specialization = trim($_POST["specialization"]);           
            $param_HospitalID = trim($_POST["hospital"]);
            
            // echo $stmt2;      
            
            if (mysqli_stmt_execute($stmt2)) {
                
                // $_COOKIE['isSuccess'] = true;
...
<body class="register_doctor_body">
    ...
    <?php if (!empty($errorMessage)): ?>
            ...
            <?php endif; ?>
        <form id="formDoctorRegister" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
            ...
            <div class="container_register SRContainer">
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="specialization">Specialization<span class="required_input_field"> *</span></label>
                    </div>
                    <div class="col-75">
                        <select name="specialization" id="specialization">
                            ...
                            <option value="<?php echo $specialization[0];?>"><?php echo $specialization[1];?></option>
                            <?php       
                            } 
                            ?>
                        </select>
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="description">Your Profile<span class="required_input_field"> *</span></label>
                    </div>
                    <div class="col-75">
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="hospital">Hospital<span class="required_input_field"> *</span></label>
                    </div>
                    <div class="col-75">
                        <select name="hospital" id="hospital">
                            ...
                            <option value="<?php echo $hospital[0];?>"><?php echo $hospital[1];?></option>
                            <?php       
                            } 
                            ?>
                        </select>
    ...
    <?php require_once('../validation/validate_doctor_register.php'); ?>
